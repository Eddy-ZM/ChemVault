...
You may need an account to use some ChemVault services. You are responsible for the accuracy of account information, maintaining the confidentiality of your credentials, and all activity under your account.

You must not share accounts in a way that bypasses access controls, usage limits, licensing rules, security controls, or organization policies. You must notify ChemVault promptly if you believe your account, password, app password, API key, OAuth connection, or session has been compromised.

ChemVault may require verification, multi-factor checks, security review, organization approval, or administrator approval before enabling certain features.

## 2. User Responsibilities

You are responsible for:

- using ChemVault only for lawful purposes;
- ensuring you have the rights and permissions needed to upload, send, process, share, or analyze content;
...
You must not use ChemVault to:

- violate laws or rights of others;
- access, test, attack, disrupt, scrape, reverse engineer, or overload systems without authorization;
- bypass rate limits, authentication, authorization, billing, or technical controls;
- distribute malware, exploit code, credential theft tools, or malicious attachments;
...
ChemVault Mail may be used only for authorized, lawful email activity. You must not use ChemVault Mail for spam, phishing, credential theft, sender spoofing, malware delivery, unauthorized bulk messaging, unlawful marketing, harassment, or impersonation.

You must not send marketing email through ChemVault unless you have all required permissions, sender identity disclosures, unsubscribe mechanisms, suppression handling, and legal approvals. Marketing email rules vary by jurisdiction and require legal review.
...
ChemVault Extract may process documents, tables, figures, citations, metadata, and user corrections to create structured scientific data. Extraction results must be treated as drafts requiring human review.
...
ChemVault may suspend, restrict, disable, or terminate accounts, sessions, API keys, app passwords, email accounts, file shares, projects, organizations, or other access where ChemVault reasonably believes it is necessary to address security risk, abuse, non-payment, legal compliance, provider requirements, investigation, or violation of these Terms.

Where practical, ChemVault may provide notice or an opportunity to remediate. Immediate action may be required for urgent security, abuse, provider, or legal reasons.

## 11. Intellectual Property

ChemVault and its licensors retain rights in the ChemVault services, software, interfaces, documentation, logos, trademarks, designs, and related materials.

These Terms do not grant you ownership of ChemVault software or services. You may not copy, modify, distribute, sell, lease, or create derivative works from ChemVault except as expressly permitted by applicable license terms or written agreement.

## 12. User Content

You retain rights you have in content you upload, send, create, or submit through ChemVault, including files, emails, prompts, molecule data, comments, corrections, datasets, and extraction inputs.

You grant ChemVault the permissions needed to host, store, transmit, process, display, analyze, secure, backup, audit, and otherwise operate the services for you and your authorized users. This includes processing by third-party providers where needed to provide the services.

You represent that you have all rights, permissions, notices, and consents needed for ChemVault to process your content.

## 13. Third-Party Services

ChemVault may depend on third-party services such as Cloudflare, Resend, OpenAI, Apple, GitHub, Supabase, OAuth providers, payment processors, DNS providers, analytics providers, and infrastructure vendors.
...
ChemVault's processing of personal information is described in the ChemVault Privacy Policy. Privacy disclosures must remain consistent with actual code, infrastructure, App Store metadata, provider contracts, and product behavior.
...
ChemVault may add, remove, suspend, change, rename, limit, or discontinue features, APIs, apps, plans, providers, routes, integrations, or documentation. ChemVault may also change rate limits, storage limits, access controls, supported file types, email limits, AI providers, pricing, or availability.

Material changes should be communicated through reasonable means where appropriate.
...
The following sections require qualified legal review before use with real customers:

- account terms, organization terms, administrator rights, and enterprise contracting;
- acceptable use policy and email anti-spam terms;
- AI disclaimers, scientific extraction disclaimers, and high-risk use restrictions;
- user content license and intellectual property terms;
- privacy, cookies, subprocessors, and data processing terms;
- payment, tax, refund, and subscription language;
- limitation of liability, warranty disclaimer, governing law, venue, dispute resolution, and consumer rights;
- App Store, TestFlight, and platform-specific terms;
- minors, students, schools, and education-related use.
