...
| Scheduled billing reconciliation | GitHub Actions with dedicated scheduler secret | Retrieve bounded non-terminal Stripe subscriptions and refresh D1 from provider truth | Missing secret, Stripe error, malformed response, or D1 failure makes the scheduled job fail visibly |
