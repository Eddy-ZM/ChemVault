...
| --- | --- | --- | --- |
| D1 `DB` binding | Server binding | Forms, leads, billing, metered usage, admin | Apply migrations before enablement; private and billing workflows fail closed when unavailable |
...
| `BILLING_SERVICE_SECRET` | Main site and authorized services | Internal entitlement and idempotent usage-consumption endpoints | Rotate on exposure and periodically; never reuse as end-user auth |
